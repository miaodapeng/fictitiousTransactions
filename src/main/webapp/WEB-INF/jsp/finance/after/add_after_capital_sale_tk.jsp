...
<script type="text/javascript" src='<%= basePath %>static/js/finance/after/add_after_capital_sale_tk.js?rnd=<%=Math.random()%>'></script>
<div class="form-list">
    <form method="post" id="addAfteCapitalSaleTkForm" ><!-- action="finance/capitalbill/saveAddCapitalBill.do" -->
        <ul>
        	<li>
                <div class="form-tips">
                    <span>*</span>
                ...
                <div class="f_left ">
                    <div class="form-blanks">
                        <ul>
                            ...
                            <c:if test="${list.sysOptionDefinitionId eq afterSalesDetailVo.traderMode}">
                            				<li>
            ...
            <li>
                ...
                <div class="f_left ">
                    <div class="form-blanks">
                        <input
                                <c:if test="${pageType==1}">disabled="disabled"</c:if>
                                type="text" name="amount" id="amount" onkeyup="value=value.replace(/[^\d.]/g,'');"
                                value='<fmt:formatNumber type="number" value="${(afterSalesDetailVo.realRefundAmount<0?-(afterSalesDetailVo.realRefundAmount):afterSalesDetailVo.realRefundAmount) - (afterSalesDetailVo.payAmount<0?-(afterSalesDetailVo.payAmount):afterSalesDetailVo.payAmount)}" pattern="0.00" maxFractionDigits="2" />'/>
            ...
            <li>
                ...
                <div class="f_left ">
                    <div class="form-blanks">
                        ...
                        <input type="hidden" name="payee" id="payee" value="${afterSalesDetailVo.payee}" />
                    </div>
                </div>
            </li>
               <!-- 如果付款方式是银行时 -->
            ...
            <!-- 开户银行 -->
            <input type="hidden" name="payeeBankName" id="payeeBankName" value="${afterSalesDetailVo.bank}" />
            <!-- 银行账号 -->
            <input type="hidden" name="payeeBankAccount" id="payeeBankAccount" value="${afterSalesDetailVo.bankAccount}"/>
            <!-- 开户行支付联行号 -->
