 ...
 <div class="formpublic">
            <form method="post" action="" id="complement">
                ...
                <div class="add-tijiao tcenter">
                	...
                	<input type="hidden" value="${traderCustomerId}" name="traderCustomerId">
...
<script type="text/javascript" src='<%= basePath %>static/js/finance/invoice/complete.js?rnd=<%=Math.random()%>'></script>
