...
<c:set var="title" value="售后开票申请列表" scope="application" />
<%@ include file="../../common/common.jsp"%>
<script type="text/javascript" src='<%=basePath%>static/js/finance/invoice/list_after_open_invoice_apply.js?rnd=<%=Math.random()%>'></script>
	<div class="main-container">
		<div class="list-pages-search">
			<form method="post" id="search" action="<%=basePath%>finance/invoice/getAfterOpenInvoiceListPage.do">
				<ul>
					<li>
				...
				<tbody>
					<c:forEach var="list" items="${openInvoiceApplyList}" varStatus="num">
						<tr>
							...
							<td><span class="pop-new-data delete" layerparams='{"width":"600px","height":"220px","title":"确认审核","link":"./auditOpenInvoice.do?invoiceApplyId=${list.invoiceApplyId}&isAdvance=0"}'>驳回</span></td>
