...
<c:set var="title" value="集中开票客户" scope="application" />
...
<script type="text/javascript">
    ...
    function subForm(){
        ...
        $("#batchCollectTrader").ajaxSubmit({
            async : false,
            url : './batchCollectTraderSave.do',
            data : $("#batchCollectTrader").serialize(),
            type : "POST",
            dataType : "json",
...
<div class="form-list  form-tips4 ml7">
    <form id="batchCollectTrader" method="post" enctype="multipart/form-data">
        <ul>
            <li style="margin-bottom:8px;">
                ...
                <div class='f_left'>
                    ...
                    <div class="pop-friend-tips" style="margin: 7px 0 0 0;">
                        如果您没有标准模板，请<a href="<%= basePath %>static/template/集中开票客户模板.xlsx">下载标准模板</a>
                    </div>
                </div>
            </li>
        </ul>
