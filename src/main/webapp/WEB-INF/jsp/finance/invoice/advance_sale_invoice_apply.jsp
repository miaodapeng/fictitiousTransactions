...
<c:set var="title" value="提前开票申请" scope="application" />
<%@ include file="../../common/common.jsp"%>
<script type="text/javascript" src='<%= basePath %>static/js/finance/invoice/advance_sale_invoice_apply.js?rnd=<%=Math.random()%>'></script>
	<div class="form-list form-tips7">
		<form method="post" id="openInvoiceApplyForm">
				...
				<li>
					...
					<div class="f_left ">
						<div class="form-blanks">
							...
							<input type="text" class="input-larger" name="comments" id="comments" onkeydown="if(event.keyCode==13)return btnSub(${invoiceApply.relatedId});"/>
			...
			<div class="pop-friend-tips">
				友情提醒<br />
				1、提前开票需经过财务部审核，请关注审核进度。
				<br />
				2、请与客户确认开票资料是否变化？开票的产品名称是否有特殊要求？如果几个订单合并开票，是否可以？收票人信息是否无变化？
				<br />
				3、与客户确认开票相关问题，是维护客户关系最自然的途径，所以，借此机会多问问题，多寒暄。
			</div>
