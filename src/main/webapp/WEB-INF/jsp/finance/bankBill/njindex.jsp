...
<c:set var="title" value="南京银行流水列表" scope="application" />
<%@ include file="../../common/common.jsp"%>
	<div class="content">
	<div class="searchfunc">
		<form method="post" id="search" action="<%=basePath%>finance/bankbill/njindex.do">
			<ul>
				<li>
			...
			<div class="tcenter">
				...
				<span class="bt-small bg-light-blue bt-bg-style mr20" onclick="exportBankBillList(2)">导出列表</span>
				
				<span class="bg-light-blue bt-bg-style bt-small" onclick="sendPayBillToKindlee(this)">发送至金蝶</span>
			</div>
		</form>
	</div>
