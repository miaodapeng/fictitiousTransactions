...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/customer/edit_finance.js?rnd=<%=Math.random()%>"></script>
        ...
        <form method="post" action="" id="myform">
            ...
            <ul>
                <li>
                    ...
                    <div class="f_left">
                        <input type="text" <c:if test="${1 eq traderCustomer.source }">disabled="disabled"</c:if> class="input-largest errobor" name="regAddress" id="regAddress" value="${traderFinance.regAddress}"/>
                    </div>
                </li>
                <li>
                    <div class="infor_name">
                    ...
                    <div class="f_left">
                        <input type="text" <c:if test="${1 eq traderCustomer.source }">disabled="disabled"</c:if> class="input-largest errobor"  name="regTel" id="regTel" value="${traderFinance.regTel}"/>
                    </div>
                </li>
                <li>
                    <div class="infor_name">
                    ...
                    <div class="f_left">
                        <input type="text" <c:if test="${1 eq traderCustomer.source }">disabled="disabled"</c:if> class="input-largest errobor"  name="taxNum" id="taxNum" value="${traderFinance.taxNum}"/>
                    </div>
                </li>
                <li>
                    <div class="infor_name">
                    ...
                    <div class="f_left">
                       <input <c:if test="${1 eq traderCustomer.source }">disabled="disabled"</c:if>  type="file" class="upload_file" id='file_1' name="lwfile" style="display: none;" onchange="uploadFile(this,1);">
                       <input <c:if test="${1 eq traderCustomer.source }">disabled="disabled"</c:if> type="text" class="input-middle" id="uri_1" readonly="readonly"
                    ...
                    <c:choose>
						...
						<c:otherwise>
	                    	...
	                    	<span <c:if test="${1 eq traderCustomer.source }">disabled="disabled"</c:if> class="font-red cursor-pointer mt4 none" onclick="del(1)" id="img_del_1">删除</span>
						</c:otherwise>
					</c:choose>
                ...
                <li>
                    ...
                    <div class="f_left">
                        <input <c:if test="${1 eq traderCustomer.source }">disabled="disabled"</c:if> type="text" class="input-largest errobor"  name="bank" id="bank" value="${traderFinance.bank}"/>
                    </div>
                </li>
                <li>
                    <div class="infor_name">
                    ...
                    <div class="f_left">
                        <input <c:if test="${1 eq traderCustomer.source }">disabled="disabled"</c:if> type="text" class="input-largest errobor" onkeyup="this.value=this.value.replace(/[^\d]/g,'') " onafterpaste="this.value=this.value.replace(/[^\d]/g,'')"  
