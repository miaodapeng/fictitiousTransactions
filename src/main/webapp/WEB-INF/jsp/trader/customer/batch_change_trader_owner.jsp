...
<script type="text/javascript">
    ...
    function subForm(){
        ...
        canSubmit=false;
        $("#batchChangeTraderOwner").ajaxSubmit({
            async : false,
            url : './batchChangeTraderOwner.do',
            data : $("#batchChangeTraderOwner").serialize(),
            type : "POST",
            dataType : "json",
...
<div class="form-list  form-tips4 ml7">
    <form id="batchChangeTraderOwner" method="post" enctype="multipart/form-data">
        <ul>
            <li style="margin-bottom:8px;">
                ...
                <div class='f_left'>
                    ...
                    <div class="pop-friend-tips" style="margin: 7px 0 0 0;">
                        如果您没有标准模板，请<a href="<%= basePath %>static/template/批量划拨客户归属销售.xlsx">下载标准模板</a>
                    </div>
                </div>
            </li>
        </ul>
