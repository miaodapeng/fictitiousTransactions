	...
	<form method="post" action="" id="myform">
		...
		<ul>
			<li>
				...
				<div class="f_left">
					<div>
						...
						</select> <select class="input-middle mr6" name="city" id="city">
							<option value="0">请选择</option>
					...
					<div>
						<span class="font-red pr" style="display: none;">省份不能为空</span> <span
							class="font-red ci" style="display: none;">地市不能为空</span> <span
							class="font-red zo" style="display: none;">区县不能为空</span>
					</div>
				</div>
			</li>
			<li>
				...
				<div class="f_left">
					<input type="text" class="input-largest errobor" name="address"
						id="address" value="${traderAddress.address}" />
			...
			<li>
				...
				<div class="f_left">
					<input type="text" class="input-largest errobor" name="zipCode"
						id="zipCode" value="${traderAddress.zipCode}" />
			...
			<li>
				...
				<div class="f_left commonuse table-largest">
					<div>
						...
						<label>常用备注:</label> <span>合同地址</span><span>收货地址</span> <span>收票地址</span>
					</div>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/static/js/customer/add_address.js?rnd=<%=Math.random()%>"></script>
