...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/customer/transfer_contact.js?rnd=<%=Math.random()%>"></script>
<div class="formpublic">
	...
	<form action="${pageContext.request.contextPath}/trader/customer/getCustomersByName.do" id="myform" method="post">
				...
				<li>
					...
					<div class='f_left'>
						<div class='inputfloat'>
							<input type="text" name="customerName" id="searchName" value="${customerName}"  class="input-largest">
