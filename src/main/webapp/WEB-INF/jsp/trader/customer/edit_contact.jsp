...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/customer/add_contact.js?rnd=<%=Math.random()%>"></script>
    ...
    <div class="baseinforeditform content">
        ...
        <form method="post" action="${pageContext.request.contextPath}/trader/customer/editSaveContact.do" id="myform">
            <ul>
                <li>
                ...
                <li>
                    ...
                    <div class="f_left">
                        <input type="text" class="input-largest errobor"  name="weixin" id="weixin" value="${traderContact.weixin}"/>
                    </div>
                </li>
                <li>
                    <div class="infor_name mt0">
            ...
            <div class="add-tijiao tcenter mt20 mb20">
            	...
            	<input type="hidden" name="customerProperty" value="${customerProperty}" >
            	<input type="hidden" id="mod" value="mod" >
                <button type="submit">提交</button>
                <button type="button" class="dele" onclick="goUrl('${pageContext.request.contextPath}/trader/customer/getContactsAddress.do?traderId=${traderCustomer.traderId}&traderCustomerId=${traderCustomer.traderCustomerId}')">取消</button>
            </div>
        </form>
    </div>
</body>
