...
<c:set var="title" value="批量新增客户" scope="application" />
...
<script type="text/javascript">
	...
	function subForm() {
		...
		$("#myform").ajaxSubmit({
			async : false,
			url : './saveuplodebatchcustomer.do',
			...
			success : function(data) {
				...
				if (data.code == 0) {
					...
					warnErrorTips("uri","uploadError",data.message);//文本框ID和提示用语
					return false;
			...
			<li>
				...
				<div class="f_left ">
					...
					<div class="pop-friend-tips" style="margin: 7px 0 0 0;">
						如果您没有标准模板，请<a
							href="<%=basePath%>static/template/模板01-批量新增客户模板.xlsx">下载标准模板</a>
					</div>
				</div>
			</li>
		</ul>
