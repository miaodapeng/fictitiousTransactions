...
<div class="baseinforcontainer" style="padding-bottom: 15px;">
	...
	<div class="baseinforeditform">
		<form method="post"
			action="${pageContext.request.contextPath}/trader/supplier/saveaddcommunicate.do"
			id="form">
			<ul>
				<li>
			...
			<div class="add-tijiao tcenter">
				...
				<button class="dele" id="close-layer" type="button"
					onclick="goUrl('${pageContext.request.contextPath}/trader/supplier/communicaterecord.do?traderId=${traderSupplier.traderId}&traderSupplierId=${traderSupplier.traderSupplierId}');">取消</button>
			</div>
		</form>
	</div>
</div>
