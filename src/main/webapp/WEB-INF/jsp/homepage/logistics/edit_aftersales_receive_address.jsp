...
<c:set var="title" value="编辑退货地址" scope="application" />
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/static/js/home/page/add_aftersales_receive_address.js?rnd=<%=Math.random()%>"></script>
