...
<c:set var="title" value="编辑分公司" scope="application" />
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/company/modify.js?rnd=<%=Math.random()%>"></script>
