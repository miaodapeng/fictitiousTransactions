...
<script type="text/javascript" src='<%=basePath%>/static/js/el/trader/add.js?rnd=<%=Math.random()%>'></script>
<div class="content">
    ...
    <div  id="desc_div" class="none">
        <form method="post" id="addForm" action="${pageContext.request.contextPath}/el/trader/saveElTraderinfo.do">
            <ul class="payplan">
                <li>
            ...
            <div class="add-tijiao tcenter mt10">
                ...
                <button type="button" class="bt-bg-style bg-deep-green" onclick="addSubmit();">新增医疗客户</button>
            </div>
        </form>
    </div>
</div>
