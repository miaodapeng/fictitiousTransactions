        ...
        <form method="post" action="" id="myform">
            <ul>
                <li>
                    ...
                    <div class="title-click   pop-new-data" style='float:left;margin:-4px 0 0 10px;' layerParams='{"width":"700px","height":"500px","title":"新增联系人","link":"${pageContext.request.contextPath}/order/bussinesschance/addTraderContact.do?traderId=${traderCustomer.traderId }&traderCustomerId=${traderCustomer.traderCustomerId }"}'>
	                                           添加联系人
	                </div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="f_left inputfloat ">
                    	<input class="Wdate input-small " type="hidden" placeholder="30天后时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="15Date" id="15Date" value="<date:date value ='${hideDate} ' format="yyyy-MM-dd"/>"  />
                        ...
                        <input class="Wdate input-small " type="text" placeholder="请选择时间" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'15Date\')}',minDate:'#F{$dp.$D(\'nowDate\')}'})" name="nextDate" id="nextDate" />
                    </div>
                </li>
                <li>
                    <div class="infor_name">
