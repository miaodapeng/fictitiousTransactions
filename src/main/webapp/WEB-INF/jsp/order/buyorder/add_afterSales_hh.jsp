                        ...
                        <ul class="aftersales">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/order/buyorder/addAfterSalesPage.do?flag=hh&&buyorderId=${buyorder.buyorderId}">
                                    <input type="radio" checked="true" name="type" value="547">
                                    <label>换货</label>
                                </a>
                            </li>
                     <!--        <li>
                    ...
                    <div class="form-blanks">
                        <ul>
                        	<c:forEach items="${sysList}" var="sys" >
                        		<c:if test="${sys.relatedField eq 547 }">
                        			<li>
                ...
                <div class="parts">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                        	...
                        	<c:if test="${bgv.goodsId ne 140633 && bgv.goodsId ne 253620 && bgv.goodsId ne 251462 && bgv.goodsId ne 127063 && bgv.goodsId ne 251526 && bgv.goodsId ne 256675}">
                        		 <tr>
	                                <td>
		                                ...
		                                <!-- 退货数量与已收货数量比较 
	                                	<c:if test="${bgv.num - bgv.afterSaleUpLimitNum gt bgv.receiveNum  || bgv.num - bgv.afterSaleUpLimitNum eq bgv.receiveNum}">
	                                		<input type="hidden" name="receiveNums" value="0">
	                                	</c:if>
	                                	<c:if test="${bgv.num - bgv.afterSaleUpLimitNum lt bgv.receiveNum}">
	                                		<input type="hidden" name="receiveNums" value="${bgv.receiveNum + bgv.afterSaleUpLimitNum - bgv.num}">
	                                	</c:if>-->
	                                	<input type="hidden" name="receiveNums" id="receiveNums_${bgv.buyorderGoodsId}" value="${bgv.receiveNum}">
	                                </td>
	                                 <td class="text-left">
	                                ...
	                                <td>${bgv.num}</td>
	                                <td>${bgv.unitName}</td>
	                                <td><input type="text" style="width:50px;" alt1="${bgv.buyorderGoodsId}">/<span alt1="${bgv.buyorderGoodsId}">${bgv.receiveNum}
	                                <!-- 
	                                	<c:if test="${bgv.num - bgv.afterSaleUpLimitNum gt bgv.receiveNum  || bgv.num - bgv.afterSaleUpLimitNum eq bgv.receiveNum}">
	                                		0
	                                	</c:if>
	                                	<c:if test="${bgv.num - bgv.afterSaleUpLimitNum lt bgv.receiveNum}">
	                                		${bgv.receiveNum + bgv.afterSaleUpLimitNum - bgv.num}
	                                	</c:if> -->
	                                	</span>
	                                </td>
	                                <td>
