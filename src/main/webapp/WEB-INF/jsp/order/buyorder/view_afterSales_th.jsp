		                         ...
		                         <td class="text-left">
			                            <div class="customername pos_rel">
		                                       <span class="brand-color1 addtitle" 
		                                       		tabTitle='{"num":"viewgoods${asg.goodsId}","link":"./goods/goods/viewbaseinfo.do?goodsId=${asg.goodsId}",
            ...
            <table class="table">
                ...
                <tbody>
              		<tr>
                        ...
                        <td class="warning-color1">${afterSalesVo.haveRefundAmount < 0 ? -afterSalesVo.haveRefundAmount : afterSalesVo.haveRefundAmount}</td>
                        <td class="warning-color1">
