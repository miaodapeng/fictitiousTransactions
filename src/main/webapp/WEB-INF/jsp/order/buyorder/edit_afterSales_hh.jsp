                ...
                <div class="f_left">
                    <div class="form-blanks">
                        <ul class="aftersales">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <input type="radio" checked="true" name="type" value="547" readonly="readonly">
                                    <label>换货</label>
                                </a>
                            </li>
                        <!--   
                    ...
                    <table class="table">
                        ...
                        <tbody>
                        	<c:forEach items="${buyorder.bgvList}" var="sgv">
                        		...
                        		<c:set var="deliveryDirect" value="" /> 
                        		<c:forEach items="${afterSales.afterSalesGoodsList}" var="asg">
                        			<c:if test="${sgv.buyorderGoodsId eq asg.orderDetailId}">
	                        		 ...
	                        		 <c:set var="deliveryDirect" value="${asg.deliveryDirect}" />
                        		</c:forEach>
                        		<c:choose>  
								    <c:when test="${contains == true }"> 
		                        		 <tr>
			                                ...
			                                <td>${sgv.num}</td>
			                                <td>${sgv.unitName}</td>
			                                <td><input type="text" style="width:50px;" alt1="${sgv.buyorderGoodsId}" value="${num}">/
		                            ...
		                            <c:otherwise>
		                            	 <tr>
			                                <td>
			                                	...
			                                	<input type="hidden" name="afterSaleNums" >
			                                	<input type="hidden" name="goodsIds" value="${asg.goodsId}">
			                                ...
			                                <td>${sgv.num}</td>
			                                <td>${sgv.unitName}</td>
			                                <td><input type="text" style="width:50px;" alt1="${sgv.buyorderGoodsId}" value="">/
