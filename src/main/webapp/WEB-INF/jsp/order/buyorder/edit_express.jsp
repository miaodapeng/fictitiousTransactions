	  ...
	  <div class="form-list  form-tips8">
        <form method="post" action="" id="">
            ...
            <div class="add-tijiao tcenter">
            	...
            	<input type="hidden" name="buyorderNo" value="${buyorderInfo.buyorderNo}"/>
...
<script type="text/javascript" src='<%= basePath %>static/js/order/buyorder/editExpress.js?rnd=<%=Math.random()%>'></script>
</html>
