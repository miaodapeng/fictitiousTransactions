	...
	<div class="main-container">
        ...
        <div class="parts">
            <div class="title-container">
                ...
                <!-- -->
                <c:if test="${afterSalesVo.atferSalesStatus ne 3 && afterSalesVo.atferSalesStatus ne 2 && payStatus ne 0 && afterSalesVo.realRefundAmount lt 0}">
        ...
        <div class="parts">
			...
			<c:if test="${afterSalesVo.atferSalesStatus ne 3 && afterSalesVo.atferSalesStatus ne 2}">
				<form action="" method="post" id="myform">
	          		...
	          		<c:if test="${afterSalesVo.refundAmountStatus ne 4 && afterSalesVo.refundAmountStatus ne 3 && afterSalesVo.refundAmount gt 0 &&
	          						(((afterSalesVo.refundAmount + afterSalesVo.payPeriodAmount) gt 0 && afterSalesVo.refund eq 2) || (afterSalesVo.payPeriodAmount gt 0 && afterSalesVo.realRefundAmount le 0))}">
             			<button type="button" class="bt-bg-style bg-light-green bt-small" onclick="executeRefundOperation();">执行退款运算</button>
             		</c:if>
             		<c:if test="${afterSalesVo.realRefundAmount lt 0 && afterSalesVo.refund eq 1 && afterSalesVo.refundAmountStatus eq 4}">
             		...
             		<c:if test="${afterSalesVo.realRefundAmount le 0 || (afterSalesVo.realRefundAmount gt 0 && afterSalesVo.realRefundAmount eq afterSalesVo.haveRefundAmount)}">
