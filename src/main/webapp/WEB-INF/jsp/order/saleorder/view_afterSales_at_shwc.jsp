...
<c:set var="title" value="售后详情-安调_审核完成" scope="application" />	
		                    ...
		                    <tr>
		                        ...
		                        <td class="caozuo">
				                	...
				                	<span class="edit-user pop-new-data" layerParams='{"width":"500px","height":"270px","title":"编辑评价",
										"link":"<%= basePath %>/aftersales/engineer/editscore.do?afterSalesInstallstionId=${asg.afterSalesInstallstionId}"}'>评价</span>
                    ...
                    <c:if test="${not empty communicateList}">
                		<c:forEach items="${communicateList}" var="communicateRecord" varStatus="">
                			<tr>
		                        ...
		                        <td><span class="font-blue" style = "cursor:pointer;" class="edit-user" onclick="checkcoidURI(${communicateRecord.relateCommunicateRecordId});" id="${communicateRecord.relateCommunicateRecordId}" name="record">${communicateRecord.communicateRecordId }</span></td>
        ...
        <div class="parts">
        	<div class="title-container">
            	...
            	<c:if test="${afterSalesVo.atferSalesStatus ne 3 and afterSalesVo.atferSalesStatus ne 2}">
	                <div class="title-click nobor  pop-new-data" 
	                	layerParams='{"width":"780px","height":"310px","title":"新增售后费用类型","link":"./addCostType.do?afterSalesId=${afterSalesVo.afterSalesId}&&costType=723"}'>新增
	                </div>
             	</c:if>
            </div>
            <table class="table">
            			...
            			<c:if test="${afterSalesVo.atferSalesStatus ne 3 and afterSalesVo.atferSalesStatus ne 2}">
	            			<td class="caozuo">
		            			...
		            			<span class="border-blue pop-new-data" layerParams='{"width":"780px","height":"310px","title":"编辑售后费用",
			                        			"link":"./getCostTypeById.do?afterSalesCostId=${list.afterSalesCostId}&&costType=723"}'>编辑</span>
	            			</td>
            			</c:if>
            		</tr>
            		</c:forEach>
