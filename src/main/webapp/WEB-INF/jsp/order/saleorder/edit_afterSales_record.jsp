...
<c:set var="title" value="编辑售后过程" scope="application" />
...
<script type="text/javascript" >
	$(function(){
		$("#myform").click(function(){
			...
			$.ajax({
				url:page_url+'/aftersales/order/saveEditAfterSalesRecord.do',
                ...
                <li>
                    ...
                    <div class="f_left ">
                        <div class="form-blanks ">
                         	<textarea name="content" id="content" placeholder="请详述售后过程内容" rows="5" class="wid90">${afterSalesRecord.content}</textarea>
	                     </div>
