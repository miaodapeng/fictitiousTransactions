...
<c:set var="title" value="售后详情-其他-审核中" scope="application" />	
...
<script type="text/javascript" src='<%= basePath %>static/js/aftersales/order/view_afterSales.js?rnd=<%=Math.random()%>'></script>
	<div class="main-container">
                ...
                <tbody>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>
                        	<div class="customername pos_rel">
                                       <span class="brand-color1 addtitle" style="float:none;">${afterSalesVo.traderName}</span><i class="iconbluemouth"></i>
                                   <div class="pos_abs customernameshow" style="display: none;">
        ...
        <div class="parts">
            ...
            <%@ include file="view_afterSales_qt_goods.jsp"%>
