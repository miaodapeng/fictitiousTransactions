            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="f_left inputfloat ">
                        <input class="Wdate input-small mr8" type="text" placeholder="请选择时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'end\')}'})" name="begin" id="begin" value="<date:date value ="${communicateRecord.begintime} "/>" />
                        <input class="Wdate input-small " type="text" placeholder="请选择时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'begin\')}'})" name="end" id="end" value="<date:date value ="${communicateRecord.endtime} "/>"/>
                    </div>
                </li>
                <li class="bt">
                    <div class="infor_name">
                       		...
                       		<c:forEach items="${communicateGoalList }" var="cm">
	                            ...
	                            <li>
	                                <input type="radio" name="communicateGoal" value="${cm.sysOptionDefinitionId }"
	                                	<c:if test="${communicateRecord.communicateGoal== cm.sysOptionDefinitionId}">
		                                checked="checked"
		                                </c:if>
	                                />
                ...
                <li>
                    ...
                    <div class="f_left inputfloat ">
                        <input class="Wdate input-small" type="text" placeholder="请选择日期" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'end\')}'})" name="nextDate" id="nextDate" value="${communicateRecord.nextContactDate }"/>
                    </div>
                </li>
                <li>
                    <div class="infor_name">
