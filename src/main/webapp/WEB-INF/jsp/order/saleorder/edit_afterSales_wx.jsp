...
<div class="form-list  form-tips5">
    <form method="post" action="<%= basePath %>/order/saleorder/saveEditAfterSales.do">
        <ul>
                ...
                <div class="f_left">
                    <div class="form-blanks">
                        <ul class="aftersales">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <input type="radio"  name="type" value="541" readonly="readonly">
                                    <label>安调</label>
                                </a>
                            </li>
                             <li>
                                <a href="javascript:void(0);">
                                    <input type="radio" name="type" checked="true" value="584" readonly="readonly">
                                    <label>维修</label>
                                </a>
                            </li>
                            </c:if>
            ...
            <input type="hidden" id="shtype-wx" value="wx" />
            <li>
                <div class="parts">
