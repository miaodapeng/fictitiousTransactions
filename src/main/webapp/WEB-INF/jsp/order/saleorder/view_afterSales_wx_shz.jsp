...
<c:set var="title" value="售后详情-维修-审核中" scope="application" />	
		                ...
		                <tbody>
		                    <tr>
		                        ...
		                        <c:if test="${afterSalesVo.verifyStatus ne 0}"></c:if>
			                     	<span class="border-blue addtitle" style="float:none;" tabTitle='{"num":"viewafterSalesId<%=System.currentTimeMillis() + (int)(Math.random()*10000) %>",
