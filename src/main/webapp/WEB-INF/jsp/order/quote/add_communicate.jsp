        ...
        <form method="post" action="" id="addCommunicate">
            <ul>
                ...
                <li>
                    ...
                    <div class="f_left ">
                        <input class="Wdate f_left input-small mr4" type="text" placeholder="请选择时间" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'end\')}'})" name="begin" id="begin" value="${startTime}"/>
                        <div class="gang mr5">-</div>
                        <input class="Wdate f_left input-small" type="text" placeholder="请选择时间" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'begin\')}'})" name="end" id="end" value="${endTime}"/>
                ...
                <li>
                    ...
                    <div class="f_left inputfloat ">
                        <input class="Wdate input-small" type="text" placeholder="请选择日期" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'end\')}'})" name="nextDate" id="nextDate"/>
                    </div>
                </li>
                <li>
                    <div class="infor_name">
