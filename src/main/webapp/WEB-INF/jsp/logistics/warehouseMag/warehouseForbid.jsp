...
<c:set var="title" value="禁用仓库" scope="application" />
			...
			<ul class="add-detail">
				<li>
					...
					<div class="f_left">
					    ...
					    <input type="hidden" id="warehouseId" name="warehouseId" value="${warehouses.warehouseId}" /> 
					    <input type="hidden" id="isEnable" name="isEnable" value="${warehouses.isEnable}" />
						<div class="font-grey9 mt10 mb20">
							友情提示<br>1、该操作将一并关闭所含的库房、货区、货架和库位；
						</div>
					</div>
