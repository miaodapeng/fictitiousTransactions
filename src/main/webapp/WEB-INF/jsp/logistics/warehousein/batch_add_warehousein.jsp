...
<c:set var="title" value="批量入库" scope="application" />
...
<script type="text/javascript">
    ...
    function subForm(){
		...
		$("#batchAddWarehouseIn").ajaxSubmit({
			async : false,
			url : './batchSaveWarehousein.do',
			data : $("#batchAddWarehouseIn").serialize(),
			type : "POST",
			dataType : "json",
...
<div class="form-list  form-tips4 ml7">
	<form id="batchAddWarehouseIn" method="post" enctype="multipart/form-data">
		<ul>
				...
				<div class='f_left'>
					<div class="form-blanks">
						<div class="pos_rel">
							...
							<input type="hidden" name="bussnissType" id="bussnissType" value="${bussnissType}">
							<input type="hidden" name="skurknum" id="skurknum" value="${skurknum}">
					...
					<div class="pop-friend-tips" style="margin: 7px 0 0 0;">
						如果您没有标准模板，请<a href="<%= basePath %>static/template/批量入库模板.xls">下载标准模板</a>
					</div>
				</div>
			</li>
		</ul>
