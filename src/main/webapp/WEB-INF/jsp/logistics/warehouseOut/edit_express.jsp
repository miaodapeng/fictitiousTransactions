	  ...
	  <div class="form-list  form-tips8">
            ...
            <table class="table">
                ...
                <c:forEach var="saleorderGoods" items="${saleorderGoodsList}">
                	 <tr>
                        ...
                        <td>
                            <input type="checkbox" name="b_checknox" value="${saleorderGoods.saleorderGoodsId}" <c:if test="${expressNumMap[saleorderGoods.saleorderGoodsId]==0 && (saleorderGoods.num == allExpressNumMap[saleorderGoods.saleorderGoodsId])}">disabled</c:if> <c:if test="${expressNumMap[saleorderGoods.saleorderGoodsId]>0}">checked</c:if> onclick="canelAll(this,'b_checknox')">
                        </td>
                        <td class="text-left">
                             <div >
                        ...
                        <input name="num" type="text" value="${expressNumMap[saleorderGoods.saleorderGoodsId]}" onchange="checkNum(this,${saleorderGoods.deliveryNum-allExpressNumMap[saleorderGoods.saleorderGoodsId]+expressNumMap[saleorderGoods.saleorderGoodsId]},${expressNumMap[saleorderGoods.saleorderGoodsId]}, ${expressNumMap[saleorderGoods.saleorderGoodsId]})">
                        </span></td>
                        <c:if test="${(saleorderGoods.deliveryNum-allExpressNumMap[saleorderGoods.saleorderGoodsId]) !=0}">
                        <td class="jianhuozongshu">${saleorderGoods.deliveryNum-allExpressNumMap[saleorderGoods.saleorderGoodsId]}</td>
                        </c:if>
                         <c:if test="${(saleorderGoods.deliveryNum-allExpressNumMap[saleorderGoods.saleorderGoodsId]) ==0}">
                        <td class="jianhuozongshu">${saleorderGoods.deliveryNum-allExpressNumMap[saleorderGoods.saleorderGoodsId]}</td>
                        </c:if>
		...
		<div class="table-style4">
            ...
            <div class="add-tijiao tcenter">
                ...
                <input type="hidden" name="delLogisticsNo" id="delLogisticsNo" value="${expressList.logisticsNo}"/>
                <input type="hidden" name="Identifier" value="编辑">
