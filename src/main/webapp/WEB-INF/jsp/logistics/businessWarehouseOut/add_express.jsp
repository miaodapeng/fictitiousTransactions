                ...
                <c:forEach var="saleorderGoods" items="${afterSalesGoodsList}">
                	 <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="b_checknox" value="${saleorderGoods.afterSalesGoodsId}"  onclick="canelAll(this,'b_checknox')">
                            </c:if>
                        </td>
                        <td class="text-left">
                           <div >
                        ...
                        <c:if test="${(saleorderGoods.deliveryNum-saleorderGoods.eNum) !=0}">
                        <td class="jianhuozongshu"><input name="num" type="text" value="${saleorderGoods.deliveryNum-saleorderGoods.eNum}" onchange="checkNum(this,${saleorderGoods.deliveryNum-saleorderGoods.eNum},${expressNumMap[saleorderGoods.afterSalesGoodsId]},0)"></td>
                        </c:if>
                         <c:if test="${(saleorderGoods.deliveryNum-saleorderGoods.eNum) ==0}">
