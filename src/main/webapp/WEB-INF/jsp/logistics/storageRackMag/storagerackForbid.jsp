...
<c:set var="title" value="禁用货架" scope="application" />
				...
				<ul class="add-detail">
					<li>
						...
						<div class="f_left">
							...
							<input type="hidden" id="storageRackId" name="storageRackId" value="${storageRack.storageRackId}"/>
							<input type="hidden" id="isEnable" name="isEnable" value="${storageRack.isEnable}"/>
							<div class="font-grey9 mt10 mb20">
								友情提示<br>1、该操作将一并关闭所含的库位；
							</div>
						</div>
