...
<c:set var="title" value="新增店铺" scope="application" />
		...
		<form method="post" id="storeform">
	        <ul class="add-detail">
	            <li>
	                ...
	                <div class="f_left">
	                	<input name="name" id="name" class="input-larger"/>
	                </div>
	                <div class="clear"></div>
	            </li>
	        </ul>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/ordergoods/store/store_add.js?rnd=<%=Math.random()%>"></script>
