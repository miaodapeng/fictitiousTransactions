...
<c:set var="title" value="生成换货二维码" scope="application" />
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th class="wid5">序号</th>
                        <th>条形码内容</th>
                        <th class="wid15">生成时间</th>
                        <th class="wid10">状态</th>
                        <th class="wid18">操作人</th>
             ...
             <div class="table-style4">
                <div class="allchose">
                    <input type="checkbox" name="all_b_checknox" onclick="selectall(this);">
                    <span>全选</span>
                </div>
                <div class="times">
                    <span class="mr10">请选择批次</span>
                    <c:forEach var="tlist" items="${timeArray}" varStatus="num">
                     <input type="checkbox" name="${tlist}" onclick="checkbarcodesh('${tlist}', this.checked,'b_checknox');">
