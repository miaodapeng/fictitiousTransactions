            ...
            <table class="table">
                ...
                <c:forEach var="afterSalesGoods" items="${afterSales.afterSalesGoodsList}">
                	 <tr>
                        ...
                        <td>${afterSalesGoods.buyorderPrice}<input type="hidden" name="price" value="${afterSalesGoods.price}"/></td>
                        <td class="jianhuozongshu"><input name="num" type="text" value="${afterSalesGoods.rknum-expressNumMap[afterSalesGoods.afterSalesGoodsId]}" onchange="checkNum(this,${afterSalesGoods.rknum},${expressNumMap[afterSalesGoods.afterSalesGoodsId]},1)"></td>
                        <td class="jianhuozongshu">
                             <span>${expressNumMap[afterSalesGoods.afterSalesGoodsId]}</span>
                             <span>/</span>
                             <span>${afterSalesGoods.rknum}</span>
                        </td>
