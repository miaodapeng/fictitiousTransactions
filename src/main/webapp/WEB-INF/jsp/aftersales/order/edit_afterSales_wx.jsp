...
<c:set var="title" value="编辑售后-维修" scope="application" />
...
<div class="form-list  form-tips5">
    <form method="post" action="<%= basePath %>/aftersales/order/saveEditAfterSales.do">
        <ul>
                    ...
                    <div class="form-blanks">
                        <ul class="aftersales">
                            <li>
                             ...
                             <li>
                                <a href="javascript:void(0);">
                                    <input type="radio" name="type" value="585" readonly="readonly" checked="true">
                                    <label>维修</label>
                                </a>
                            </li>
                            <!-- 
            ...
            <input type="hidden" id="" name="thGoodsId" value="140633" />
            ...
            <input type="hidden" name="beforeParams" value='${beforeParams}'/>
            	...
            	<li>
                    ...
                    <div class="f_left ">
                        <div class="form-blanks ">
                            <textarea name="comments" id="comments" placeholder="请详述客户需求及维修要求以便售后同事联系" rows="5" class="wid90">${afterSales.comments}</textarea>
                        </div>
