...
<%@ include file="../../common/common.jsp"%>    
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/aftersales/order/add_communicate.js?rnd=<%=Math.random()%>"></script>
        ...
        <form method="post" action="" id="myform">
            ...
            <!-- 
            	...
            	<li>
                    ...
                    <div class="f_left  ">
                    	<div>
                        <select class="mr5" name="afterSalesTraderId" id="afterSalesTraderId">
                            <option selected="selected" value="0">请选择</option>
                            <c:choose>
                            	<c:when test="${not empty afterSalesTraders }">
	                            	<c:forEach	items="${afterSalesTraders }" var="list">
	                            		<option value="${list.afterSalesTraderId }">
	                            		${list.traderName }
	                            		</option>
	                            	</c:forEach>
                            	</c:when>
