...
<script type="text/javascript" >
	$(function(){
		$("#add_submit").click(function(){
			...
			$.ajax({
				url:page_url+'/aftersales/order/addAfterSalesCost.do',
		...
		<form action="" method="post" id="myform" enctype="multipart/form-data">
			<ul>
				...
				<li>
                    ...
                    <div class="f_left  ">
                        <input type="text" class="input-largest" name="amount" id="amount">
				...
				<li>
					...
					<div class="f_left ">
                        <div class="form-blanks ">
                         	<textarea name="comments" id="comments" placeholder="" rows="5" class="wid60"></textarea>
	                     </div>
