...
<c:set var="title" value="退票材料-售后" scope="application" />
            ...
            <div class="mt20 overflow-hidden">
                ...
                <div class='f_left'>
	                <div class='pos_rel f_left'>
	                    <input type="file" class="uploadErp" name="lwfile" id="lwfile" onchange="uploadFile(this, 588)">
	                    <input type="text" class="input-middle" id="uri_588" placeholder="" name="uri" onclick="lwfile.click();">
	                    <label class="bt-bg-style bt-middle bg-light-blue ml4" type="file" >浏览</label>
	                    <input type="hidden" id="domain_588" name="domain" value="">
	                    <input type="hidden" id="file_name_588" name="name" value="">
	                    <input type="hidden"  name="relatedId" value="${afterSalesId }">
	                    <input type="hidden"  name="attachmentFunction" value="588">
                    </div>
                    <div class="f_left">
	                    <i class="iconsuccesss mt5 none" id="img_icon_588"></i>
	              		<a href="" target="_blank" class="font-blue cursor-pointer mr5 ml10 mt4 none" id="img_view_588">查看</a>
	                   	<span class="font-red cursor-pointer mt4 none" onclick="delProductImg(588)" id="img_del_588">删除</span>
                	</div>
                   	<div class='clear'></div> 
