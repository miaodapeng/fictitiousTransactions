...
<c:set var="title" value="新增售后-维修" scope="application" />
        ...
        <ul>
                        ...
                        <ul class="aftersales">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/aftersales/order/addAfterSalesPage.do?flag=wx">
                                    <input type="radio" name="type" value="585" checked="true">
                                    <label>维修</label>
                                </a>
                            </li>
                            <!-- 
            ...
            <input type="hidden" name="formToken" value="${formToken}"/>
            	...
            	<li>
                    ...
                    <div class="f_left ">
                        <div class="form-blanks ">
                            <textarea name="comments" id="comments" placeholder="请描述客户需求和需要维修的产品" rows="5" class="wid90"></textarea>
                        </div>
