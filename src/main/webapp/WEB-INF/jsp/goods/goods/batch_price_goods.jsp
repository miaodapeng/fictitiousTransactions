...
<script type="text/javascript">
    ...
    function subForm(){
		...
		$("#batchPriceGoods").ajaxSubmit({
			async : false,
			url : './batchPriceGoodsSave.do',
			data : $("#batchPriceGoods").serialize(),
			type : "POST",
			dataType : "json",
...
<div class="form-list   form-tips4 ml7">
	<form id="batchPriceGoods" method="post" enctype="multipart/form-data">
		<ul>
			<li style="margin-bottom:8px;">
				...
				<div class="f_left ">
					...
					<div class="pop-friend-tips" style="margin: 7px 0 0 0;">
						如果您没有标准模板，请<a href="<%=basePath%>static/template/模板05-产品批量核价模板.xlsx">下载标准模板</a>
					</div>
				</div>
			</li>
		</ul>
