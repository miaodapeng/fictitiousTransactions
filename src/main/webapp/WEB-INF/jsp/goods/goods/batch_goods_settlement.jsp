...
<c:set var="title" value="批量上传核价信息" scope="application" />
...
<script type="text/javascript">
    ...
    function subForm(){
		...
		$("#batchGoodsSettlement").ajaxSubmit({
			async : false,
			url : './batchGoodsSettelmentSave.do',
			data : $("#batchGoodsSettlement").serialize(),
			type : "POST",
			dataType : "json",
...
<div class="form-list   form-tips4 ml7">
	<form id="batchGoodsSettlement" method="post" enctype="multipart/form-data">
		<ul>
			<li style="margin-bottom:8px;">
				...
				<div class="f_left ">
					...
					<div class="pop-friend-tips" style="margin: 7px 0 0 0;">
						如果您没有标准模板，请<a href="<%=basePath%>static/template/模板54-产品批量修改结算价.xlsx">下载标准模板</a>
					</div>
				</div>
			</li>
		</ul>
