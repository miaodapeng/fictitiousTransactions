...
$(function() {
            ...
            if (windowTop > fixdivPosTop && ($(fixdiv).outerHeight() > ($(window).height() - nextSiblingHeit))) {
                ...
                $(fixdiv).scroll(function() {
                    ...
                    if (fixdivScrollTop > 0) {
                        ...
                        $('.white-space').show();
                         if (1120<$(window).width() && $(window).width()<1400) {
                                 $('.white-space').css('right',"15px");
                        }else if($(window).width()<1120){
                                 $('.white-space').css('right',"13px");
                        }else{
                                 $('.white-space').css('right',"17px");
                        }
    ...
    function movingHeadNormal() {
        ...
        $(window).scroll(function() {
            ...
            if ($(normalListPage).html() != undefined && $(normalListPage).html() != '') {
