...
artDialog.fn = artDialog.prototype = {
	...
	close: function () {
        ...
        // IE10+ iframe form item get item, then click the close button, the parent window form item can't be focus bug
        if (isIE) {
            ...
            focusElem.style.cssText = 'position:absolute; top:' + (top + 100) + 'px; left:-500px;';
            focusElem.focus();
            setTimeout(function(){
                focusElem.blur();
...
if (_skin) {
	...
	link.rel = 'stylesheet';
	link.href = _path + '/skins/' + _skin[1] + '.css?' + artDialog.fn.version;
