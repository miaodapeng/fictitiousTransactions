...
public class SalesPerformanceTraderDetail {
    private Integer salesPerformanceTraderDetailId;
    ...
    public Integer getSalesPerformanceTraderDetailId() {
        return salesPerformanceTraderDetailId;
    }

    public void setSalesPerformanceTraderDetailId(Integer salesPerformanceTraderDetailId) {
        this.salesPerformanceTraderDetailId = salesPerformanceTraderDetailId;
    }
