...
public class SalesPerformanceOrdersDetail {
    private Integer salesPerformanceOrdersDetailId;
    ...
    public Integer getSalesPerformanceOrdersDetailId() {
        return salesPerformanceOrdersDetailId;
    }

    public void setSalesPerformanceOrdersDetailId(Integer salesPerformanceOrdersDetailId) {
        this.salesPerformanceOrdersDetailId = salesPerformanceOrdersDetailId;
    }
