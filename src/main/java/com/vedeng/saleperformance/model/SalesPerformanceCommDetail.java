...
public class SalesPerformanceCommDetail {
    private Integer salesPerformanceCommDetailId;
    ...
    public Integer getSalesPerformanceCommDetailId() {
        return salesPerformanceCommDetailId;
    }

    public void setSalesPerformanceCommDetailId(Integer salesPerformanceCommDetailId) {
        this.salesPerformanceCommDetailId = salesPerformanceCommDetailId;
    }
